...
from ollama_ai_connect import get_model_default_ollama, get_models_ollama, get_llm_ollama
from openrouter_connect import llm_list_openrouter, get_model_default_openrouter, get_llm_openrouter
from together_ai_connect import llm_list_together, get_llm_together, get_model_default_together
from openai_connect import get_llm_openai, get_models_openai, get_model_default_openai
...
def get_model_default() -> str:
    if use_provider == "openai":
        return get_model_default_openai()
    elif use_provider == "openrouter":
        return get_model_default_openrouter()
    elif use_provider == "together":
        return get_model_default_together()
    elif use_provider == "ollama":
        return get_model_default_ollama()
    else:
        raise ValueError(f"Unsupported provider: {use_provider}")
